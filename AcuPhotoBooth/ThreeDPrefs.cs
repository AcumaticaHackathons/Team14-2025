...
namespace AcuPhotoBooth
{
    ...
    [PXPrimaryGraph(typeof(ThreeDPrefMaint))]
    public class ThreeDPrefs : PXBqlTable, IBqlTable
    {
        ...
        [PXUIField(DisplayName = "MeshyKey")]
        public virtual string MeshyKey { get; set; }
        public abstract class meshyKey : PX.Data.BQL.BqlString.Field<meshyKey> { }
        #endregion
